...
/*const myDpStyles: string = require('./my-date-picker.component.scss');
...
export class MyDatePicker implements OnChanges, ControlValueAccessor {
  ...
  visibleMonth: IMyMonth = {monthTxt: '', monthTxtFull: '', monthNbr: 0, year: 0};
  selectedMonth: IMyMonth = {monthTxt: '', monthTxtFull: '', monthNbr: 0, year: 0};
  ...
  onMonthCellClicked(cell: IMyCalendarMonth): void {
    ...
    this.visibleMonth = {
      ...
      monthTxtFull: this.monthTextFull(cell.nbr),
      monthNbr: cell.nbr,
      year: this.visibleMonth.year
    };
  ...
  onYearCellClicked(cell: IMyCalendarYear): void {
    ...
    this.visibleMonth = {
      ...
      monthTxtFull: this.visibleMonth.monthTxtFull,
  ...
  onUserDateInput(value: string): void {
    ...
    if (value.length === 0) {
      ...
      let date: IMyDate = this.utilService.isDateValid(value, this.opts.dateFormat, this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.disableWeekends, this.opts.disableWeekdays, this.opts.disableDays, this.opts.disableDateRanges, this.opts.monthLabels, this.opts.monthLabelsFull, this.opts.enableDays);
  ...
  parseOptions(): void {
    ...
    if (this.dayIdx !== -1) {
      ...
      for (let i = 0; i < weekDays.length; i++) {
        ...
        this.weekDaysFull.push(this.opts.dayLabelsFull[weekDaysFull[idx]]);
    ...
    if (value && (value['date'] || value['jsdate'] || value['formatted'])) {
      ...
      if (cvc) {
        this.visibleMonth = {
          ...
          monthTxtFull: this.opts.monthLabelsFull[this.selectedDate.month],
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes.hasOwnProperty('defaultMonth')) {
      ...
      if (dm !== null && dm !== undefined && dm !== '') {
        ...
        this.selectedMonth = {monthTxt: '', monthTxtFull: '', monthNbr: 0, year: 0};
      }
      dmChange = true;
    }
  ...
  setVisibleMonth(): void {
    ...
    this.visibleMonth = {
      ...
      monthTxtFull: this.opts.monthLabelsFull[m],
      monthNbr: m,
      year: y
    };
  ...
  onPrevMonth(): void {
    ...
    this.visibleMonth = {monthTxt: this.monthText(m), monthTxtFull: this.monthTextFull(m), monthNbr: m, year: y};
    this.generateCalendar(m, y, true);
  }
  ...
  onTodayClicked(): void {
    ...
    if (this.opts.inline && today.year !== this.visibleMonth.year || today.month !== this.visibleMonth.monthNbr) {
      this.visibleMonth = {
        ...
        monthTxtFull: this.opts.monthLabelsFull[today.month],
  ...
  getWeekday(date: IMyDate): string {
    ...
    const weekDays: Array<string> = this.utilService.getWeekDays();
    ...
    for (let i = 1; i < 7; i++) {
      ...
      if (i === 1) {
        ...
        for (let j = pm; j <= dInPrevM; j++) {
          ...
          week.push({
            dateObj: date, cmo: cmo, currDay: this.isCurrDay(j, m, y, cmo, today), weekDay: this.weekDaysFull[j],
        ...
        for (let j = 0; j < daysLeft; j++) {
          ...
          week.push({
            dateObj: date, cmo: cmo, currDay: this.isCurrDay(dayNbr, m, y, cmo, today), weekDay: this.weekDaysFull[j],
            disabled: this.utilService.isDisabledDay(date, this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.disableWeekends, this.opts.disableWeekdays, this.opts.disableDays, this.opts.disableDateRanges, this.opts.enableDays),
            markedDate: this.utilService.isMarkedDate(date, this.opts.markDates, this.opts.markWeekends),
            highlight: this.utilService.isHighlightedDate(date, this.opts.sunHighlight, this.opts.satHighlight, this.opts.highlightDates)
          });
        ...
        for (let j = 1; j < 8; j++) {
          ...
          week.push({
            dateObj: date, cmo: cmo, currDay: this.isCurrDay(dayNbr, m, y, cmo, today), weekDay: this.weekDaysFull[j-1],
            disabled: this.utilService.isDisabledDay(date, this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.disableWeekends, this.opts.disableWeekdays, this.opts.disableDays, this.opts.disableDateRanges, this.opts.enableDays),
            markedDate: this.utilService.isMarkedDate(date, this.opts.markDates, this.opts.markWeekends),
            highlight: this.utilService.isHighlightedDate(date, this.opts.sunHighlight, this.opts.satHighlight, this.opts.highlightDates)
          });
